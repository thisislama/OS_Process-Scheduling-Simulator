...
public class OSproject {
    ...
    public static void scheduleProcesses(Process[] processes, int CS) {
        ...
        printResults(ganttChart, totalTurnaround, totalWaiting, totalIdleTime, CS, contextSwitches, currentTime, n, processes);
    }

    public static void printResults(List<String> ganttChart, int totalTurnaround, int totalWaiting, int totalIdleTime, int CS, int contextSwitches, int totalTime, int n, Process[] processes) {
        System.out.println("\nNumber of processes: " + n);
        System.out.println("Arrival times and burst times as follows:");
        for (Process p : processes) {
            System.out.printf("P%d: Arrival = %d, Burst = %d\n", p.id, p.arrivalTime, p.burstTime);
        }

        System.out.println("Context Switch: " + CS + " ms");
